export const DEMO_STUDENT_EMAIL = process.env.NEXT_PUBLIC_DEMO_STUDENT_EMAIL ?? "demo.estudiante@coffeebiocharcademy.com";
export const DEMO_ADMIN_EMAIL   = process.env.NEXT_PUBLIC_DEMO_ADMIN_EMAIL   ?? "demo.admin@coffeebiocharcademy.com";
